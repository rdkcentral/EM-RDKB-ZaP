...
if __name__ == "__main__":
    ...
    raise SystemExit(pytest.main([
        ...
        f"{BASE_DIR}/test/testscripts/scale_validation_stability/TS_controller_agent_connectivity.py",
        ...
        f"{BASE_DIR}/test/testscripts/scale_validation/TS_client_association_baseline.py",
        f"{BASE_DIR}/test/testscripts/scale_validation/TS_controller_agent_connectivity_baseline.py",
        ...
        f"{BASE_DIR}/test/testscripts/link_stability/TS_backhaul_rssi_stability.py",
